...
const register = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const req_body = JSON.parse((_a = req.body) === null || _a === void 0 ? void 0 : _a.data);
        ...
        const user = yield (0, auth_services_1.createUser)(Object.assign(Object.assign({}, user_body), { dp: (_b = req.file) === null || _b === void 0 ? void 0 : _b.path }));
        res.status(201).json({
...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const credential_body = (0, validation_1.validate_login_body)(req.body);
